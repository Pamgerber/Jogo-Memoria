...
int main()
{
    ...
    int selectMenu, jogadas, paresEncontrados; //Controles do programa e pontuaÃ§Ã£o no jogo
    int peca1L, peca2L, peca1C, peca2C; //Variáveis para Linha e Coluna das peças selecionadas pelo jogador
    bool posicaoVazia; //condição dos loops da linha 134 e 167. Repetir caso posicÃ£o informada já esteja sendo utilizada.
    ...
    do //Do-While Loop do Programa. Sair caso selecao do menu seja 3-Fim.
    {
        ...
        //If-ElseIf para seleção do menu, 1-Jogar
        if(selectMenu == 1) /*************************** JOGAR ***************************/
        {
            ...
            switch(rand() % TAM + 1) //Condição ao número aleatório de 1-4
            {
            ...
            do
            {
                ...
                } while (posicaoVazia != true); //Do-while para repetir caso a posicao informada jÃ¡ esteja sendo utilizada
                ...
                //If-Else para verificar se as peÃ§as selecionadas formam um par
